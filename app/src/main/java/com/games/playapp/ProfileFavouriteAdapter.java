...
public class ProfileFavouriteAdapter extends RecyclerView.Adapter<ProfileFavouriteAdapter.BoardgamesFavouriteAdapterViewHolder> {
    ...
    public ProfileFavouriteAdapter(@NonNull Context context, BoardgamesFavouriteAdapterOnClickHandler clickHandler) {
        mContext = context;
